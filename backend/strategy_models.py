"""Pydantic models for the DryLine-upgraded strategy engine.

These are separate from the existing main.py models to avoid any conflict.
Used by strategy_decision.py and the new /api/* routes in main.py.
"""
