"""Frame quality gate for the DryLine-upgraded strategy engine.

Fast rejection of corrupted / blurry / badly exposed / frozen frames.
A bad image never produces a new tyre recommendation.
"""
from __future__ import annotations

import cv2
import numpy as np
from strategy_models import QualityMetrics
